...
```mermaid
graph TD
    Act1["Act I: Whispers in the Sluices (Level 10)<br>Infiltrate the Sluice Districts & Expose the Chemical Rings"] --> Act2["Act II: The Fleshwarped Foundry (Level 11)<br>Raid the Thessalan Consortium's Subterranean Vats"]
    Act2 --> Act3["Act III: Crimson Sails Over the Quay (Level 12)<br>Defend against the Githyanki Air Raid & Forge the Tri-Weave Shroud"]
    Act3 --> Act4["Act IV: The Deepmind Annex (Level 13)<br>Descend into the Brine-Veins & Seal the The Void of Madness Tear"]
```
