...
while ((match = regex.exec(htmlContent)) !== null) {
    const title = match[4];
    if (title.includes("The Drowned Counting Room")) {
        let contentArr;
        try {
        ...
        fs.writeFileSync('C:\\Users\\sline\\.gemini\\antigravity\\brain\\bd0be9a8-fcf9-4037-a05c-11b98aa54433\\scratch\\ch11_current.md', text);
        console.log(`Extracted Chapter 11 by Title`);
        break;
    }
}
