...
while ((match = regex.exec(htmlContent)) !== null) {
    ...
    if (number === "15") {
        ...
        fs.writeFileSync('C:\\Users\\sline\\.gemini\\antigravity\\brain\\bd0be9a8-fcf9-4037-a05c-11b98aa54433\\scratch\\ch15_current.md', text);
        console.log(`Extracted Chapter 15: ${match[4]}`);
        break;
    }
}
