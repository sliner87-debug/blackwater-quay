...
while ((match = regex.exec(htmlContent)) !== null) {
    const title = match[4];
    if (title.includes("Sable's Sorting")) {
        let contentArr;
        try {
        ...
        fs.writeFileSync('C:\\Users\\sline\\.gemini\\antigravity\\brain\\bd0be9a8-fcf9-4037-a05c-11b98aa54433\\scratch\\ch9_current.md', text);
        console.log(`Extracted Chapter 9 by Title`);
        break;
    }
}
