...
setTimeout(() => {
    ...
    document.getElementById('select-weapon3').value = 'necrotic';
    ...
    console.log("ACTIONS RENDERED 2:", actions.includes('Singularity'));
    console.log("ACTIONS RENDERED 3:", actions.includes('Soul-Seeker'));
}, 500);
