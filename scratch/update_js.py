...
js_content = '''// Sovereign Shipyards Logic
...
# The rest of shipyard.js is VTT logic which we want to preserve.
with open('h:/Antigravity/Novel/shipyard.js', 'r') as f:
    original = f.read()

vtt_split = original.split('// --- VTT VISUAL BUILDER LOGIC ---')
if len(vtt_split) > 1:
    vtt_logic = '// --- VTT VISUAL BUILDER LOGIC ---' + vtt_split[1]
else:
    vtt_logic = ''
