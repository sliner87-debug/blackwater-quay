...
while ((match = regex.exec(htmlContent)) !== null) {
    const title = match[4];
    if (title.includes("The Dead-Drop Chapel")) {
        let contentArr;
        try {
        ...
        fs.writeFileSync('C:\\Users\\sline\\.gemini\\antigravity\\brain\\bd0be9a8-fcf9-4037-a05c-11b98aa54433\\scratch\\ch10_current.md', text);
        console.log(`Extracted Chapter 10 by Title`);
        break;
    }
}
