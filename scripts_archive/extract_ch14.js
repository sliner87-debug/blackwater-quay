...
while ((match = regex.exec(htmlContent)) !== null) {
    ...
    if (number === "14") {
        ...
        fs.writeFileSync('C:\\Users\\sline\\.gemini\\antigravity\\brain\\bd0be9a8-fcf9-4037-a05c-11b98aa54433\\scratch\\ch14_current.md', text);
        console.log(`Extracted Chapter 14: ${match[4]}`);
        break;
    }
}
